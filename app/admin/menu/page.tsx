      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Tambah, ubah, atau hapus menu makanan & minuman
          </p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={(open) => { if (!open) handleDialogClose(); }}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle>
                {editingItem ? 'Ubah Menu' : 'Tambah Menu Baru'}
              </DialogTitle>
              <DialogDescription>
                {editingItem
                  ? 'Perbarui detail item menu'
                ...
                <div className="space-y-3">
                  {items
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center justify-between p-3 border border-primary/10 rounded-lg hover:bg-primary/5 transition-colors"
                      >
